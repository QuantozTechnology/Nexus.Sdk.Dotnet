...
public interface IAccountsFacade
{
    ...
    /// <param name="accountType">Optional type for account (Defaults to a managed account)</param>
    /// <returns>A transaction that needs to be signed using the private key that matches the provided public key</returns>
    public Task<SignableResponse> CreateOnStellarAsync(string customerCode, string publicKey, IEnumerable<TokenCodeWithData> tokenCodesWithData, string? customerIPAddress = null, string? customName = null, string? accountType = "MANAGED");
    ...
    /// <param name="accountType">Optional type for account (Defaults to a managed account)</param>
    /// <returns>A transaction that needs to be signed using the private key that matches the provided public key</returns>
    public Task<SignableResponse> CreateOnAlgorandAsync(string customerCode, string publicKey, IEnumerable<TokenCodeWithData> tokenCodesWithData, string? customerIPAddress = null, string? customName = null, string? accountType = "MANAGED");
    ...
    /// <param name="customerIPAddress">Optional IP address of the customer used for tracing their actions</param>
    /// <returns>A transaction that needs to be signed using the private key of the provided account</returns>
    public Task<SignableResponse> ConnectToTokenAsync(string accountCode, TokenCodeWithData tokenCodeWithData, string? customerIPAddress = null);
    ...
    /// <param name="customerIPAddress">Optional IP address of the customer used for tracing their actions</param>
    /// <returns>A transaction that needs to be signed using the private key of the provided account</returns>
    public Task<SignableResponse> ConnectToTokensAsync(string accountCode, IEnumerable<TokenCodeWithData> tokenCodesWithData, string? customerIPAddress = null);
