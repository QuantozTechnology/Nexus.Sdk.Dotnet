    ...
    public class CustomerRequestBuilderTests
    {
        ...
        public void CustomerRequestBuilderTests_Build_Default()
        {
            var request = new CustomerRequestBuilder(
                "MOCK_CUSTOMER", "Trusted", "EUR", "NL", "MOCK_EXTERNAL_CODE").Build();
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(request.ExternalCustomerCode, Is.EqualTo("MOCK_EXTERNAL_CODE"));
        ...
        {
            var request = new CustomerRequestBuilder(
                "MOCK_CUSTOMER", "Trusted", "EUR", "NL", "MOCK_EXTERNAL_CODE")
                .SetStatus(status)
                .Build();
        ...
        [Test]
        public void CustomerRequestBuilderTests_Build_Data()
        {
