...
public interface IAccountsFacade
{
    ...
    public Task<AccountResponse> CreateOnStellarAsync(string customerCode, string publicKey);
    ...
    public Task<SignableResponse> CreateOnStellarAsync(string customerCode, string publicKey, IEnumerable<string> allowedTokens);
    ...
    /// <returns>The Nexus account that is created</returns>
    public Task<AccountResponse> CreateOnAlgorandAsync(string customerCode, string publicKey);
    ...
    /// <param name="allowedTokens">A list of token codes the account will be connected to upon creation</param>
    /// <returns>A transaction that needs to be signed using the private key that matches the provided public key</returns>
    public Task<SignableResponse> CreateOnAlgorandAsync(string customerCode, string publicKey, IEnumerable<string> allowedTokens);
    ...
    public Task<SignableResponse> ConnectToTokenAsync(string accountCode, string tokenCode);
    ...
    /// <returns>A transaction that needs to be signed using the private key of the provided account</returns>
    public Task<SignableResponse> ConnectToTokensAsync(string accountCode, IEnumerable<string> tokenCodes);
}
